      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-row gap-3 items-center">
          ...
          <label htmlFor="image1">
            <img src={!image1 ? assets.upload_area : URL.createObjectURL(image1)} className={`w-22 rounded-lg ${image1 ? 'w-33 h-33 object-contain' : '' }`} alt="" />
            <input
          ...
          <label htmlFor="image2">
            <img src={!image2 ? assets.upload_area : URL.createObjectURL(image2)} className={`w-22 rounded-lg ${image2 ? 'w-33 h-33 object-contain' : '' }`} alt="" />
            <input
          ...
          <label htmlFor="image3">
            <img src={!image3 ? assets.upload_area : URL.createObjectURL(image3)} className={`w-22 rounded-lg ${image3 ? 'w-33 h-33 object-contain' : '' }`} alt="" />
            <input
          ...
          <label htmlFor="image4">
            <img src={!image4 ? assets.upload_area : URL.createObjectURL(image4)} className={`w-22 rounded-lg ${image4 ? 'w-33 h-33 object-contain' : '' }`} alt="" />
            <input
